...
(function () {
    ...
    var CircleCenterSplit = [
        {"left":{"url":"https://txcdn.ylll111.xyz/khj/CircleCenter_1_split_left.png","w":"238","h":"407","rs":Math.PI*2},
         "right":{"url":"https://txcdn.ylll111.xyz/khj/CircleCenter_1_split_right.png","w":"230","h":"407","cutx":"26","rs":Math.PI*2}},
        {"left":{"url":"https://txcdn.ylll111.xyz/khj/CircleCenter_2_split_left.png","w":"238","h":"407","rs":Math.PI*2},
         "right":{"url":"https://txcdn.ylll111.xyz/khj/CircleCenter_2_split_right.png","w":"230","h":"407","cutx":"26","rs":Math.PI*2}},
        {"left":{"url":"https://txcdn.ylll111.xyz/khj/CircleCenter_3_split_left.png","w":"238","h":"407","rs":Math.PI*2},
         "right":{"url":"https://txcdn.ylll111.xyz/khj/CircleCenter_3_split_right.png","w":"230","h":"407","cutx":"26","rs":Math.PI*2}},
    ]
    //弹夹剩余子弹数
    ...
    var isup = true;
    // //口红资源数组
    // var arrayLipstick = ["https://txcdn.ylll111.xyz/khj/Lipstick_1.png","https://txcdn.ylll111.xyz/khj/Lipstick_2.png"];
    // //中心圆资源数组
    // var arrayCenterCircle = ["https://txcdn.ylll111.xyz/khj/CircleCenter_1.png","https://txcdn.ylll111.xyz/khj/CircleCenter_2.png"];
    //口红资源数组
    var arrayLipstick = ["https://txcdn.ylll111.xyz/khj/Lipstick_1.png","https://txcdn.ylll111.xyz/khj/Lipstick_2.png","https://txcdn.ylll111.xyz/khj/Lipstick_3.png"];
    //中心圆资源数组
    var arrayCenterCircle = ["https://txcdn.ylll111.xyz/khj/CircleCenter_1.png","https://txcdn.ylll111.xyz/khj/CircleCenter_2.png","https://txcdn.ylll111.xyz/khj/CircleCenter_3.png"];
    //关卡资源
    var levelUrl = [
        {"normal":"https://txcdn.ylll111.xyz/khj/level_icon_1_active.png","active":"https://txcdn.ylll111.xyz/khj/level_icon_1_active.png"},
        {"normal":"https://txcdn.ylll111.xyz/khj/level_icon_2.png","active":"https://txcdn.ylll111.xyz/khj/level_icon_2_active.png"},
        {"normal":"https://txcdn.ylll111.xyz/khj/level_icon_3.png","active":"https://txcdn.ylll111.xyz/khj/level_icon_3_active.png"}
    ]
...
/*        context.font = CircleCenterText+" PingFangSC-Semibold Arial"+ "border";
        ...
        if(this.restNum>=10){
            ...
            $("#bulletsNum1").attr("src","https://txcdn.ylll111.xyz/khj/"+Math.floor(this.restNum/10)+".png")
            $("#bulletsNum2").attr("src","https://txcdn.ylll111.xyz/khj/"+this.restNum%10+".png")

        }else{
            $("#bulletsNum2").attr("src","")
            $("#bulletsNum2").css("display","none")
            $("#bulletsNum1").attr("src","https://txcdn.ylll111.xyz/khj/"+this.restNum+".png")
        }
    };
    ...
    Game.prototype = {
        ...
        init:function (){
            ...
            ballimg.src = 'https://txcdn.ylll111.xyz/khj/CircleCenter_1.png';
        ...
        normalResults:function(){
            if(this.bulletCircles[BulletCirclesIndex]){
                this.bulletCircles[BulletCirclesIndex].imgObj.src = "https://txcdn.ylll111.xyz/khj/Sword_small_"+this.level+"_gray.png";
                BulletCirclesIndex++;
        ...
        nextLevel:function (){
           ...
           if (self.level <= self.levelLength) {
               ...
               $("#levelSwitchBoxMain").attr("src", "https://txcdn.ylll111.xyz/khj/level_"+self.level+"_main.jpg");
        ...
        levelChange:function (){
            ...
            for(i = 0; i < lens; i++){
                ...
                tempClipImg.src = "https://txcdn.ylll111.xyz/khj/Sword_small_"+this.level+".png";
