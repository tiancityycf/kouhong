...
(function () {
    ...
    var CircleCenterSplit = [
        {"left":{"url":"images/CircleCenter_1_split_left.png","w":"238","h":"407","rs":Math.PI*2},
         "right":{"url":"images/CircleCenter_1_split_right.png","w":"230","h":"407","cutx":"26","rs":Math.PI*2}},
        {"left":{"url":"images/CircleCenter_2_split_left.png","w":"238","h":"407","rs":Math.PI*2},
         "right":{"url":"images/CircleCenter_2_split_right.png","w":"230","h":"407","cutx":"26","rs":Math.PI*2}},
        {"left":{"url":"images/CircleCenter_3_split_left.png","w":"238","h":"407","rs":Math.PI*2},
         "right":{"url":"images/CircleCenter_3_split_right.png","w":"230","h":"407","cutx":"26","rs":Math.PI*2}},
    ]
    //弹夹剩余子弹数
    ...
    var isup = true;
    // //口红资源数组
    // var arrayLipstick = ["images/Lipstick_1.png","images/Lipstick_2.png"];
    // //中心圆资源数组
    // var arrayCenterCircle = ["images/CircleCenter_1.png","images/CircleCenter_2.png"];
    //口红资源数组
    var arrayLipstick = ["images/Lipstick_1.png","images/Lipstick_2.png","images/Lipstick_3.png"];
    //中心圆资源数组
    var arrayCenterCircle = ["images/CircleCenter_1.png","images/CircleCenter_2.png","images/CircleCenter_3.png"];
    //关卡资源
    var levelUrl = [
        {"normal":"images/level_icon_1_active.png","active":"images/level_icon_1_active.png"},
        {"normal":"images/level_icon_2.png","active":"images/level_icon_2_active.png"},
        {"normal":"images/level_icon_3.png","active":"images/level_icon_3_active.png"}
    ]
...
/*        context.font = CircleCenterText+" PingFangSC-Semibold Arial"+ "border";
        ...
        if(this.restNum>=10){
            ...
            $("#bulletsNum1").attr("src","./images/"+Math.floor(this.restNum/10)+".png")
            $("#bulletsNum2").attr("src","./images/"+this.restNum%10+".png")

        }else{
            $("#bulletsNum2").attr("src","")
            $("#bulletsNum2").css("display","none")
            $("#bulletsNum1").attr("src","./images/"+this.restNum+".png")
        }
    };
    ...
    Game.prototype = {
        ...
        normalResults:function(){
            if(this.bulletCircles[BulletCirclesIndex]){
                this.bulletCircles[BulletCirclesIndex].imgObj.src = "./images/Sword_small_"+this.level+"_gray.png";
                BulletCirclesIndex++;
        ...
        levelChange:function (){
            ...
            for(i = 0; i < lens; i++){
                ...
                tempClipImg.src = "./images/Sword_small_"+this.level+".png";
