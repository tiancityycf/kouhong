...
<body>
    ...
    <div class="levelSwitchBox" id="levelSwitchBox" style="display: block;">
        <img id="levelSwitchBoxMain" class="levelSwitchBoxMain" src="images/level_1_main.jpg">
    </div>
        ...
        <div class="game" id="game" style="width: 596px; height: 938px;">
            ...
            <div id="bm" style="width: 100%; height: 100%;position: fixed;background-color: rgba(0,0,0,0);top: 5.3rem; transform: translate(-5%,-1%); z-index: 2">
                ...
                <div class="levelbox" id="levelbox">
                    <div class="level"><img id="level_1" src="images/level_icon_1_active.png"></div>
                    <div class="level"><img id="level_2" src="images/level_icon_2_active.png"></div>
                    <div class="level"><img id="level_3" src="images/level_3.png"></div>
                </div>
    ...
    <div class="layoutRoot " id="app" data-game_id="" data-openid="">
        <div class="game" id="game" style="width: 596px; height: 938px;">
            ...
            <div class="bulletsNumBox">
                <img class="bulletsNum" id="bulletsNum1" src="images/6.png">
            </div>
            <canvas style="position: relative;z-index: 3" id="gameStage" width="596" height="938"></canvas>
            <div id="bm" style="width: 100%; height: 100%;position: fixed;background-color: rgba(0,0,0,0);top: 5.3rem; transform: translate(-5%,-1%); z-index: 2">
            </div>
            ...
            <div class="levelbox" id="levelbox">
                <div class="level"><img id="level_1" src="images/level_icon_1_active.png"></div>
                <div class="level"><img id="level_2" src="images/level_icon_2.png"></div>
                <div class="level"><img id="level_3" src="images/level_icon_3.png"></div>
            </div>
