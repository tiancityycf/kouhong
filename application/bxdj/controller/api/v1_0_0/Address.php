...
class Address
{
	...
	{
		//前台测试链接：http://www.zhuqian.com/bxdj/api/v1_0_0/address/index.html?openid=1
	...
	{
		//前台测试链接：http://www.zhuqian.com/bxdj/api/v1_0_0/address/create_addr.html?openid=1&nickname='kevin'&phone=15888888888&addr='长沙岳麓区'&region='湖南';
	...
	{
		//前台测试链接：http://www.zhuqian.com/bxdj/api/v1_0_0/address/set_default_addr.html?openid=1&id=3;
	...
	{
		//前台测试链接：http://www.zhuqian.com/bxdj/api/v1_0_0/address/edit_addr.html?id=3&openid=1&nickname='kevin'&phone=15888888888&addr='长沙岳麓区'&region='湖南'&ty=getInfo;
	...
	{
		//前台测试链接：http://www.zhuqian.com/bxdj/api/v1_0_0/address/del_addr.html?id=7
		require_params('id');
		$id = Request::param('id');
        $AddressModel = new AddressModel();
