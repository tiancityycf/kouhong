...
class Group
{
	...
	{
		//前台测试链接：https://hz.zxmn2018.com/bxdj/api/v1_0_1/Group/index.html?openid=oFGa94hlqh7ZTPk90Z0uihyEpGPc&group_id=12;	
		...
		if(!$is_grouper = $groupPersonsModel->where(['openid'=>$data['openid'],'group_id'=>$data['group_id']])->find()){
			...
			//查看您自己的团队的具体信息
			$group_info = $groupModel->alias('g')->join('t_group_persons a','g.id = a.group_id')->field('g.id,g.group_name,g.group_steps,g.rank,g.nums,g.status,a.contribute_steps,a.get_reward')->where(['g.id'=>$data['group_id'],'a.openid'=>$data['openid']])->find();
	...
	{
		//前台测试链接：https://hz.zxmn2018.com/bxdj/api/v1_0_1/Group/create_group.html?openid=oFGa94hlqh7ZTPk90Z0uihyEpGPc&activity_id=5&group_name='巅峰对决';
	...
	{
		//前台测试链接：https://hz.zxmn2018.com/bxdj/api/v1_0_1/Group/join_group.html?openid=oFGa94rlE20Dam4W_eUFWOYDNJ5A&activity_id=5&group_id=12;	
	...
	{
		//前台测试链接：https://hz.zxmn2018.com/bxdj/api/v1_0_1/Group/leave_group.html?openid=oFGa94rlE20Dam4W_eUFWOYDNJ5A&group_id=12;	
	...
	{
		//前台测试链接：https://hz.zxmn2018.com/bxdj/api/v1_0_1/Group/contribute_steps.html?openid=1&encryptedData=1&iv=1&group_id=8;	
   ...
   */
	...
	{
		//前台测试链接：https://hz.zxmn2018.com/bxdj/api/v1_0_1/Group/redpacket.html?openid=oFGa94hlqh7ZTPk90Z0uihyEpGPc&group_id=38&phone=8&contact_name=aa;	
