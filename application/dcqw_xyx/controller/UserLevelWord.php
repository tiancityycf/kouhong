...
class UserLevelWord extends BasicAdmin
{
    ...
    public function index()
    {
        ...
        return  $this->fetch('admin@user_level_word/dcqw_index', $result);
    }
    ...
    public function add()
    {
        ...
        return  $this->fetch('admin@user_level_word/dcqw_form', ['vo' => $data, 'type' => 'user_level_word']);
    }
    ...
    public function edit()
    {
        ...
        return  $this->fetch('admin@user_level_word/dcqw_form', ['vo' => $vo->toArray(), 'type' => 'user_level_word']);
    }
