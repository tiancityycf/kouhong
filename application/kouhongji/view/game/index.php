...
<html lang="en" style="font-size: 79.5424px;"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title></title>
    <link rel="stylesheet" href="__STATIC__/kouhongji/game/game.cssv={:time()}">
    <script type="text/javascript" src="__STATIC__/kouhongji/game/bodymovin.js"></script>
    <script type="text/javascript" src="__STATIC__/kouhongji/game/jweixin-1.3.2.js"></script>
    <script typet="text/javascript" src="__STATIC__/kouhongji/game/jquery-3.3.1.min.js"></script>
    <script type="text/javascript" src="__STATIC__/kouhongji/game/jquery.cookie.js"></script>
    <script type="text/javascript" src="__STATIC__/kouhongji/game/JicemoonMobileTouch.js"></script>
    <?php if($game==1){?>
    <script type="text/javascript" src="__STATIC__/kouhongji/game/HardestGame1.jsv={:time()}"></script>
    <script type="text/javascript" src="__STATIC__/kouhongji/game/index1.jsv={:time()}"></script>
    <?php }elseif($game==2){ ?>
    <script type="text/javascript" src="__STATIC__/kouhongji/game/HardestGame.jsv={:time()}"></script>
    <script type="text/javascript" src="__STATIC__/kouhongji/game/index.jsv={:time()}"></script>
    <?php } ?>
</head>
<body>
