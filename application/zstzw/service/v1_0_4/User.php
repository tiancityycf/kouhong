...
use app\zstzw\service\Complain as ComplainService;

use app\zstzw\service\v1_0_4\Notify as NotifyService;
...
class User
{
    ...
    public function login($code)
    {
        ...
        if (isset($data['openid'])) {
            ...
            $result = ['status' => 1, 'user_id' => $user->id, 'last_login' => $time, 'tiaozhuan_num' => $user->userRecord->tiaozhuan_num];
        } else {
            $result = ['status' => 0];
        }
