...
class UserLevelWord extends BasicAdmin
{
    ...
    public function add()
    {
        ...
        return  $this->fetch('admin@user_level_wordform', ['vo' => $data, 'type' => 'user_level_word']);
    }
    ...
    public function edit()
    {
        ...
        return  $this->fetch('admin@user_level_wordform', ['vo' => $vo->toArray(), 'type' => 'user_level_word']);
    }
