...
class Word
{
	...
	public function getRandWords($userId)
	{
        ...
        //根据玩家等级来设定题目难度
        $wordLevelArr = ConfigService::get('word_level_of_user_level_' . $userRecord['user_level']);
        $wordLevelCountArr = ConfigService::get('word_level_count_of_user_level_' . $userRecord['user_level']);
        $wordLevelTimeLimitArr = ConfigService::get('word_level_time_limit_of_user_level_' . $userRecord['user_level']);
