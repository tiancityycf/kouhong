...
class Goods extends BasicAdmin
{
    ...
    public function redisSave()
    {
        ...
        foreach ($good_cates as $k => $v) {
            ...
            $arr = Db::name('good_cates')->alias('a')->join(['t_goods' => 'b'], 'a.id=b.cate')->where(['b.status' => 1, 'a.id' => $v['id']])->order('b.order desc')->column('b.id, a.cate_name, b.title, b.is_partner, b.img, b.stock, b.price', 'a.id');
