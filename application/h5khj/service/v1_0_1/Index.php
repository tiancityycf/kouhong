...
use app\h5khj\model\SpecialPrize as SpecialPrizeModel;
use app\h5khj\model\User as UserModel;
use app\h5khj\model\UserSpecialPrize as UserSpecialPrizeModel;
use app\h5khj\model\ExchangeLog as ExchangeLogModel;
use app\h5khj\model\Goods as GoodsModel;
use think\Db;
...
class Index
{
    ...
    {
        //筛选最火热的四件兑换商品的SQL:
        //SELECT good_id,count(*) as nums FROM `dbh5khj`.`t_exchange_log` GROUP BY good_id ORDER BY nums desc LIMIT 4
