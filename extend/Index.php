...
class Index {
    ...
    public function getIndexInfo($userId) {
        ...
        $openOtherApp = $this->getConfigValue($config_data, 'open_other_app');//ConfigService::get('open_other_app');
        $openShareUser = $this->getConfigValue($config_data, 'open_share_user');//ConfigService::get('open_share_user');
        ...
        return [
            ...
            'right_top_title' => $this->getConfigValue($config_data,'right_top_title') ? sprintf($this->getConfigValue($config_data,'right_top_title'), $who) : '',
            'right_top_img' => $this->getConfigValue($config_data,'right_top_img'),
    ...
    public function tixian_info() {
        return [
            'tixian_chenggong' => ConfigService::get('tixian_chenggong'),
            'tixian_shibai' => ConfigService::get('tixian_shibai'),
            'tixian_dashangxian' => ConfigService::get('tixian_dashangxian'),
            'tixian_danhao_yishiyong' => ConfigService::get('tixian_danhao_yishiyong'),
            'zhaobudao_danhao' => ConfigService::get('zhaobudao_danhao'),
            'tixian_moren_wenzi' => ConfigService::get('tixian_moren_wenzi'),
        ];
    }
